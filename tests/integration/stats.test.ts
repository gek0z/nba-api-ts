...
import { NBAClient, type FetchFn } from '../../src/index.js';
...
describe.skipIf(SKIP)('Stats Integration', () => {
  ...
  describe('Player', () => {
    ...
    test('playerGameLog', async () => {
      const res = await nba.stats.playerGameLog({ playerID: PLAYER_ID, season: SEASON });
      expect(res.playerGameLog).toBeArray();
      expect(res.playerGameLog.length).toBeGreaterThan(0);
    }, TIMEOUT);

    test('playerGameLogs', async () => {
      const res = await nba.stats.playerGameLogs({ season: SEASON, playerID: PLAYER_ID });
    ...
    test('playerNextNGames', async () => {
      const res = await nba.stats.playerNextNGames({ playerID: PLAYER_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
    ...
    test('playerFantasyProfileBarGraph', async () => {
      const res = await nba.stats.playerFantasyProfileBarGraph({ playerID: PLAYER_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('playerCompare', async () => {
      const res = await nba.stats.playerCompare({ playerIDList: '203999', vsPlayerIDList: '2544', season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('playerVsPlayer', async () => {
      const res = await nba.stats.playerVsPlayer({ playerID: PLAYER_ID, vsPlayerID: PLAYER_ID_2, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('playerCareerByCollege', async () => {
      const res = await nba.stats.playerCareerByCollege({ college: 'Kentucky' });
      expect(res).toBeDefined();
    }, TIMEOUT);
  ...
  describe('Player Dashboard', () => {
    test('playerDashboardByGeneralSplits', async () => {
      const res = await nba.stats.playerDashboardByGeneralSplits({ playerID: PLAYER_ID, season: SEASON });
      expect(res.overallPlayerDashboard).toBeArray();
    }, TIMEOUT);

    test('playerDashboardByClutch', async () => {
      const res = await nba.stats.playerDashboardByClutch({ playerID: PLAYER_ID, season: SEASON });
      expect(res.overallPlayerDashboard).toBeArray();
    }, TIMEOUT);

    test('playerDashboardByGameSplits', async () => {
      const res = await nba.stats.playerDashboardByGameSplits({ playerID: PLAYER_ID, season: SEASON });
      expect(res.overallPlayerDashboard).toBeArray();
    }, TIMEOUT);

    test('playerDashboardByLastNGames', async () => {
      const res = await nba.stats.playerDashboardByLastNGames({ playerID: PLAYER_ID, season: SEASON });
      expect(res.overallPlayerDashboard).toBeArray();
    }, TIMEOUT);

    test('playerDashboardByShootingSplits', async () => {
      const res = await nba.stats.playerDashboardByShootingSplits({ playerID: PLAYER_ID, season: SEASON });
      expect(res.overallPlayerDashboard).toBeArray();
    }, TIMEOUT);

    test('playerDashboardByTeamPerformance', async () => {
      const res = await nba.stats.playerDashboardByTeamPerformance({ playerID: PLAYER_ID, season: SEASON });
      expect(res.overallPlayerDashboard).toBeArray();
    }, TIMEOUT);

    test('playerDashboardByYearOverYear', async () => {
      const res = await nba.stats.playerDashboardByYearOverYear({ playerID: PLAYER_ID });
      expect(res.overallPlayerDashboard).toBeArray();
    }, TIMEOUT);
  });
  ...
  describe('Player Tracking', () => {
    test('playerDashPtPass', async () => {
      const res = await nba.stats.playerDashPtPass({ playerID: PLAYER_ID, teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('playerDashPtReb', async () => {
      const res = await nba.stats.playerDashPtReb({ playerID: PLAYER_ID, teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('playerDashPtShots', async () => {
      const res = await nba.stats.playerDashPtShots({ playerID: PLAYER_ID, teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('playerDashPtShotDefend', async () => {
      const res = await nba.stats.playerDashPtShotDefend({ playerID: PLAYER_ID, teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Common', () => {
    test('commonAllPlayers', async () => {
      const res = await nba.stats.commonAllPlayers({ leagueID: '00', season: SEASON, isOnlyCurrentSeason: 1 });
    ...
    test('commonPlayoffSeries', async () => {
      const res = await nba.stats.commonPlayoffSeries({ leagueID: '00', season: '2023-24' });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('commonTeamRoster', async () => {
      const res = await nba.stats.commonTeamRoster({ teamID: TEAM_ID, season: SEASON });
  ...
  describe('Team', () => {
    test('teamInfoCommon', async () => {
      const res = await nba.stats.teamInfoCommon({ teamID: TEAM_ID, season: SEASON });
    ...
    test('teamGameLog', async () => {
      const res = await nba.stats.teamGameLog({ teamID: TEAM_ID, season: SEASON });
    ...
    test('teamHistoricalLeaders', async () => {
      const res = await nba.stats.teamHistoricalLeaders({ teamID: TEAM_ID });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('teamGameStreakFinder', async () => {
  ...
  describe('Team Dashboard', () => {
    test('teamDashboardByGeneralSplits', async () => {
      const res = await nba.stats.teamDashboardByGeneralSplits({ teamID: TEAM_ID, season: SEASON });
      expect(res.overallTeamDashboard).toBeArray();
    }, TIMEOUT);

    test('teamDashboardByShootingSplits', async () => {
      const res = await nba.stats.teamDashboardByShootingSplits({ teamID: TEAM_ID, season: SEASON });
      expect(res.overallTeamDashboard).toBeArray();
    }, TIMEOUT);
  });
  ...
  describe('Team Lineups', () => {
    test('teamDashLineups', async () => {
      const res = await nba.stats.teamDashLineups({ teamID: TEAM_ID, season: SEASON });
      expect(res.lineups).toBeArray();
    }, TIMEOUT);

    test('teamPlayerDashboard', async () => {
      const res = await nba.stats.teamPlayerDashboard({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('teamPlayerOnOffSummary', async () => {
      const res = await nba.stats.teamPlayerOnOffSummary({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('teamPlayerOnOffDetails', async () => {
      const res = await nba.stats.teamPlayerOnOffDetails({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Team Tracking', () => {
    test('teamDashPtPass', async () => {
      const res = await nba.stats.teamDashPtPass({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('teamDashPtReb', async () => {
      const res = await nba.stats.teamDashPtReb({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('teamDashPtShots', async () => {
      const res = await nba.stats.teamDashPtShots({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Team Misc', () => {
    ...
    test('teamVsPlayer', async () => {
      const res = await nba.stats.teamVsPlayer({ teamID: TEAM_ID, vsPlayerID: PLAYER_ID_2, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('teamAndPlayersVsPlayers', async () => {
      const res = await nba.stats.teamAndPlayersVsPlayers({
        teamID: TEAM_ID,
        playerID1: DEN_P1, playerID2: DEN_P2, playerID3: DEN_P3, playerID4: DEN_P4, playerID5: DEN_P5,
        vsTeamID: TEAM_ID_2,
        vsPlayerID1: LAL_P1, vsPlayerID2: LAL_P2, vsPlayerID3: LAL_P3, vsPlayerID4: LAL_P4, vsPlayerID5: LAL_P5,
        season: SEASON,
      });
      expect(res).toBeDefined();
    }, TIMEOUT);
  ...
  describe('League Dash Player', () => {
    ...
    test('leagueDashPlayerBioStats', async () => {
      const res = await nba.stats.leagueDashPlayerBioStats({ season: SEASON });
    ...
    test('leagueDashPlayerShotLocations', async () => {
      const res = await nba.stats.leagueDashPlayerShotLocations({ season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
    ...
    test('leagueDashPtStats', async () => {
      const res = await nba.stats.leagueDashPtStats({ season: SEASON, ptMeasureType: 'SpeedDistance' });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('League Dash Team', () => {
    ...
    test('leagueDashTeamShotLocations', async () => {
      const res = await nba.stats.leagueDashTeamShotLocations({ season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
  ...
  describe('League Game', () => {
    test('leagueGameFinder', async () => {
      const res = await nba.stats.leagueGameFinder({ playerOrTeamAbbreviation: 'T', season: SEASON });
    ...
    test('leagueLineupViz', async () => {
      const res = await nba.stats.leagueLineupViz({ season: SEASON, minutesMin: '10' });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('leaguePlayerOnDetails', async () => {
      const res = await nba.stats.leaguePlayerOnDetails({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
  ...
  describe('Box Score V3', () => {
    test('boxScoreTraditionalV3', async () => {
      const res = await nba.stats.boxScoreTraditionalV3({ gameID: GAME_ID }) as any;
    ...
    test('boxScoreAdvancedV3', async () => {
      const res = await nba.stats.boxScoreAdvancedV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);

    test('boxScoreMiscV3', async () => {
      const res = await nba.stats.boxScoreMiscV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);

    test('boxScoreScoringV3', async () => {
      const res = await nba.stats.boxScoreScoringV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);

    test('boxScoreUsageV3', async () => {
      const res = await nba.stats.boxScoreUsageV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);

    test('boxScoreFourFactorsV3', async () => {
      const res = await nba.stats.boxScoreFourFactorsV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);

    test('boxScoreSummaryV3', async () => {
      const res = await nba.stats.boxScoreSummaryV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);

    test('boxScoreMatchupsV3', async () => {
      const res = await nba.stats.boxScoreMatchupsV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);

    test('boxScorePlayerTrackV3', async () => {
      const res = await nba.stats.boxScorePlayerTrackV3({ gameID: GAME_ID }) as any;
      expect(res.gameId).toBe(GAME_ID);
    }, TIMEOUT);
  });
  ...
  describe('Scoreboard', () => {
    test('scoreboardV2', async () => {
      const res = await nba.stats.scoreboardV2({ gameDate: GAME_DATE, dayOffset: 0 });
      expect(res.gameHeader).toBeArray();
      expect(res.lineScore).toBeArray();
    }, TIMEOUT);

    test('scoreboardV3', async () => {
      const res = await nba.stats.scoreboardV3({ gameDate: GAME_DATE, leagueID: '00' }) as any;
  ...
  describe('Schedule', () => {
    test('scheduleLeagueV2', async () => {
      const res = await nba.stats.scheduleLeagueV2({ season: SEASON, leagueID: '00' }) as any;
      expect(res.seasonYear).toBeDefined();
      expect(res.gameDates).toBeArray();
    }, TIMEOUT);

    test('scheduleLeagueV2Int', async () => {
      // International schedule — may return empty or error
      try {
        const res = await nba.stats.scheduleLeagueV2Int({ season: SEASON, leagueID: '00' });
        expect(res).toBeDefined();
      } catch {
  ...
  describe('Shot Chart', () => {
    test('shotChartDetail', async () => {
      const res = await nba.stats.shotChartDetail({ playerID: PLAYER_ID, teamID: TEAM_ID, season: SEASON });
    ...
    test('shotChartLineupDetail', async () => {
      const res = await nba.stats.shotChartLineupDetail({ season: SEASON, leagueID: '00' });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Standings', () => {
    ...
    test('leagueStandingsV3', async () => {
      const res = await nba.stats.leagueStandingsV3({ season: SEASON, leagueID: '00' });
      expect(res.standings).toBeArray();
    }, TIMEOUT);

    test('iSTStandings', async () => {
      const res = await nba.stats.iSTStandings({ season: SEASON, leagueID: '00' }) as any;
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('playoffPicture', async () => {
      const res = await nba.stats.playoffPicture({ leagueID: '00', seasonID: '22024' });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Leaders & Homepage', () => {
    test('leagueLeaders', async () => {
      const res = await nba.stats.leagueLeaders({ season: SEASON, statCategory: 'PTS' });
    ...
    test('homePageLeaders', async () => {
      const res = await nba.stats.homePageLeaders({ season: SEASON, statCategory: 'Points' });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('homePageV2', async () => {
      const res = await nba.stats.homePageV2({ season: SEASON, statType: 'Traditional' });
      expect(res).toBeDefined();
    }, TIMEOUT);
    ...
    test('defenseHub', async () => {
      const res = await nba.stats.defenseHub({ season: SEASON, leagueID: '00' });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Draft', () => {
    ...
    test('draftBoard', async () => {
      // Known to potentially return empty/error
      try {
        const res = await nba.stats.draftBoard({ leagueID: '00', season: '2024' });
        expect(res).toBeDefined();
      } catch {
    ...
    test('draftCombineNonStationaryShooting', async () => {
      const res = await nba.stats.draftCombineNonStationaryShooting({ season: '2024' });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Cume Stats', () => {
    test('cumeStatsPlayer', async () => {
      const res = await nba.stats.cumeStatsPlayer({ playerID: PLAYER_ID, season: SEASON, gameIDs: GAME_ID });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('cumeStatsPlayerGames', async () => {
      const res = await nba.stats.cumeStatsPlayerGames({ playerID: PLAYER_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('cumeStatsTeam', async () => {
      const res = await nba.stats.cumeStatsTeam({ teamID: TEAM_ID, season: SEASON, gameIDs: GAME_ID });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('cumeStatsTeamGames', async () => {
      const res = await nba.stats.cumeStatsTeamGames({ teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Fantasy', () => {
    ...
    test('infographicFanDuelPlayer', async () => {
      const res = await nba.stats.infographicFanDuelPlayer({ gameID: GAME_ID });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('dunkScoreLeaders', async () => {
      try {
        const res = await nba.stats.dunkScoreLeaders({ season: SEASON, leagueID: '00' });
        expect(res).toBeDefined();
      } catch {
  ...
  describe('Game Misc', () => {
    ...
    test('winProbabilityPBP', async () => {
      const res = await nba.stats.winProbabilityPBP({ gameID: GAME_ID });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('synergyPlayTypes', async () => {
      const res = await nba.stats.synergyPlayTypes({ season: SEASON, playType: 'Isolation', playerOrTeam: 'P', typeGrouping: 'offensive' });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('Video', () => {
    test('videoStatus', async () => {
      const res = await nba.stats.videoStatus({ gameDate: GAME_DATE, leagueID: '00' });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test('videoDetails', async () => {
      try {
        const res = await nba.stats.videoDetails({ playerID: PLAYER_ID, teamID: TEAM_ID, season: SEASON });
        expect(res).toBeDefined();
      } catch {
    ...
    test('videoEvents', async () => {
      try {
        const res = await nba.stats.videoEvents({ gameID: GAME_ID, gameEventID: 1 });
        expect(res).toBeDefined();
      } catch {
        // May fail due to Akamai protection
      }
    ...
    test.skip('videoDetailsAsset — Akamai blocked', async () => {
      const res = await nba.stats.videoDetailsAsset({ playerID: PLAYER_ID, teamID: TEAM_ID, season: SEASON });
      expect(res).toBeDefined();
    }, TIMEOUT);

    test.skip('videoEventsAsset — Akamai blocked', async () => {
      const res = await nba.stats.videoEventsAsset({ gameID: GAME_ID, gameEventID: 1 });
      expect(res).toBeDefined();
    }, TIMEOUT);
  });
  ...
  describe('G-League / Misc', () => {
    test('gLAlumBoxScoreSimilarityScore', async () => {
      try {
