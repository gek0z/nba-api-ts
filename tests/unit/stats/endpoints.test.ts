...
describe('Player Endpoints', () => {
  ...
  test('playerGameLog', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerGameLog({ playerID: 203999, season: '2024-25' });
  ...
  test('playerNextNGames', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerNextNGames({ playerID: 203999, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('playerFantasyProfileBarGraph', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerFantasyProfileBarGraph({ playerID: 203999, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('playerCompare', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerCompare({ playerIDList: '203999', vsPlayerIDList: '2544', season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('playerVsPlayer', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerVsPlayer({ playerID: 203999, vsPlayerID: 2544, season: '2024-25' });
    expect(res).toBeDefined();
  });
...
describe('Player Dashboard Endpoints', () => {
  test('playerDashboardByGeneralSplits', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashboardByGeneralSplits({ playerID: 203999, season: '2024-25' });
  ...
  test('playerDashboardByClutch', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashboardByClutch({ playerID: 203999, season: '2024-25' });
    expect(res.overallPlayerDashboard).toBeArray();
  });
  ...
  test('playerDashboardByGameSplits', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashboardByGameSplits({ playerID: 203999, season: '2024-25' });
    expect(res.overallPlayerDashboard).toBeArray();
  });
  ...
  test('playerDashboardByLastNGames', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashboardByLastNGames({ playerID: 203999, season: '2024-25' });
    expect(res.overallPlayerDashboard).toBeArray();
  });
  ...
  test('playerDashboardByShootingSplits', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashboardByShootingSplits({ playerID: 203999, season: '2024-25' });
    expect(res.overallPlayerDashboard).toBeArray();
  });
  ...
  test('playerDashboardByTeamPerformance', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashboardByTeamPerformance({ playerID: 203999, season: '2024-25' });
    expect(res.overallPlayerDashboard).toBeArray();
  });
  ...
  test('playerDashboardByYearOverYear', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashboardByYearOverYear({ playerID: 203999 });
    expect(res.overallPlayerDashboard).toBeArray();
  });
});
...
describe('Player Tracking Endpoints', () => {
  test('playerDashPtPass', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashPtPass({ playerID: 203999, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('playerDashPtReb', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashPtReb({ playerID: 203999, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('playerDashPtShots', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashPtShots({ playerID: 203999, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('playerDashPtShotDefend', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.playerDashPtShotDefend({ playerID: 203999, season: '2024-25' });
    expect(res).toBeDefined();
  });
});
...
describe('Common Endpoints', () => {
  test('commonAllPlayers', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.commonAllPlayers({ leagueID: '00', season: '2024-25', isOnlyCurrentSeason: 1 });
  ...
  test('commonTeamRoster', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.commonTeamRoster({ teamID: 1610612743, season: '2024-25' });
...
describe('Team Endpoints', () => {
  test('teamInfoCommon', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamInfoCommon({ teamID: 1610612743, season: '2024-25' });
  ...
  test('teamGameLog', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamGameLog({ teamID: 1610612743, season: '2024-25' });
  ...
  test('teamPlayerDashboard', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamPlayerDashboard({ teamID: 1610612743, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('teamPlayerOnOffSummary', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamPlayerOnOffSummary({ teamID: 1610612743, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('teamPlayerOnOffDetails', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamPlayerOnOffDetails({ teamID: 1610612743, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('teamDashboardByGeneralSplits', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamDashboardByGeneralSplits({ teamID: 1610612743, season: '2024-25' });
  ...
  test('teamDashboardByShootingSplits', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamDashboardByShootingSplits({ teamID: 1610612743, season: '2024-25' });
    expect(res.overallTeamDashboard).toBeArray();
  });
  ...
  test('teamDashLineups', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamDashLineups({ teamID: 1610612743, season: '2024-25' });
  ...
  test('teamDashPtPass', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamDashPtPass({ teamID: 1610612743, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('teamDashPtReb', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamDashPtReb({ teamID: 1610612743, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('teamDashPtShots', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.teamDashPtShots({ teamID: 1610612743, season: '2024-25' });
    expect(res).toBeDefined();
  });
});
...
describe('League Endpoints', () => {
  ...
  test('leagueDashPlayerShotLocations', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.leagueDashPlayerShotLocations({ season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('leagueDashTeamShotLocations', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.leagueDashTeamShotLocations({ season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('leagueDashPtStats', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.leagueDashPtStats({ season: '2024-25', ptMeasureType: 'SpeedDistance' });
    expect(res).toBeDefined();
  });
  ...
  test('leagueGameFinder', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.leagueGameFinder({ playerOrTeamAbbreviation: 'T', season: '2024-25' });
  ...
  test('leagueLeaders', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.leagueLeaders({ season: '2024-25', statCategory: 'PTS' });
  ...
  test('leagueStandingsV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.leagueStandingsV3({ season: '2024-25', leagueID: '00' });
    expect(res.standings).toBeArray();
  });
...
describe('Box Score V3 Endpoints', () => {
  test('boxScoreTraditionalV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreTraditionalV3({ gameID: '0022400561' }) as any;
  ...
  test('boxScoreAdvancedV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreAdvancedV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
    expect(res.homeTeam).toBeDefined();
    expect(res.awayTeam).toBeDefined();
  });
  ...
  test('boxScoreSummaryV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreSummaryV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
  });
  ...
  test('boxScoreMiscV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreMiscV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
  });
  ...
  test('boxScoreScoringV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreScoringV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
  });
  ...
  test('boxScoreUsageV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreUsageV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
  });
  ...
  test('boxScoreFourFactorsV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreFourFactorsV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
  });
  ...
  test('boxScoreMatchupsV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScoreMatchupsV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
  });
  ...
  test('boxScorePlayerTrackV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.boxScorePlayerTrackV3({ gameID: '0022400561' }) as any;
    expect(res.gameId).toBe('0022400561');
  });
});
...
describe('Scoreboard Endpoints', () => {
  test('scoreboardV2', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.scoreboardV2({ gameDate: '2025-01-15', dayOffset: 0 });
  ...
  test('scoreboardV3', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.scoreboardV3({ gameDate: '2025-01-15', leagueID: '00' }) as any;
...
describe('Schedule Endpoints', () => {
  test('scheduleLeagueV2', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.scheduleLeagueV2({ season: '2024-25', leagueID: '00' }) as any;
...
describe('Shot Chart Endpoints', () => {
  test('shotChartDetail', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.shotChartDetail({ playerID: 203999, season: '2024-25', teamID: 1610612743 });
...
describe('Standings & Misc', () => {
  test('iSTStandings', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.iSTStandings({ season: '2024-25', leagueID: '00' }) as any;
...
describe('Leaders & Homepage', () => {
  ...
  test('homePageLeaders', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.homePageLeaders({ season: '2024-25', statCategory: 'Points' });
    expect(res).toBeDefined();
  });
  ...
  test('homePageV2', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.homePageV2({ season: '2024-25', statType: 'Traditional' });
    expect(res).toBeDefined();
  });
});
...
describe('Cume Stats Endpoints', () => {
  test('cumeStatsPlayer', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.cumeStatsPlayer({ playerID: 203999, season: '2024-25', gameIDs: '0022400561' });
    expect(res).toBeDefined();
  });
  ...
  test('cumeStatsPlayerGames', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.cumeStatsPlayerGames({ playerID: 203999, season: '2024-25' });
    expect(res).toBeDefined();
  });
  ...
  test('cumeStatsTeam', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.cumeStatsTeam({ teamID: 1610612743, season: '2024-25', gameIDs: '0022400561' });
    expect(res).toBeDefined();
  });
  ...
  test('cumeStatsTeamGames', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.cumeStatsTeamGames({ teamID: 1610612743, season: '2024-25' });
    expect(res).toBeDefined();
  });
});
...
describe('Fantasy Endpoints', () => {
  ...
  test('infographicFanDuelPlayer', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.infographicFanDuelPlayer({ gameID: '0022400561' });
    expect(res).toBeDefined();
  });
});
...
describe('Other Endpoints', () => {
  test('synergyPlayTypes', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.synergyPlayTypes({ season: '2024-25', playType: 'Isolation', playerOrTeam: 'P', typeGrouping: 'offensive' });
    expect(res).toBeDefined();
  });
  ...
  test('videoStatus', async () => {
    ...
    const nba = createClient();
    const res = await nba.stats.videoStatus({ gameDate: '2025-01-15', leagueID: '00' });
    expect(res).toBeDefined();
  });
});
