import { NBA_STATS_HEADERS, NBA_CDN_HEADERS } from './headers.js';
import { NBAApiError, NBATimeoutError, NBANetworkError } from './errors.js';
...
export class FetchClient {
  ...
  constructor(
    ...
    this.headers = options.headers ?? (baseUrl.includes('stats.nba.com') ? NBA_STATS_HEADERS : NBA_CDN_HEADERS);
