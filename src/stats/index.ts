...
export class StatsClient {
  ...
  allTimeLeadersGrids(params: AllTimeLeadersGridsParams): Promise<AllTimeLeadersGridsResponse> {
  ...
  boxScoreAdvancedV2(params: BoxScoreAdvancedV2Params): Promise<BoxScoreAdvancedV2Response> {
    return boxScoreAdvancedV2(this.client, params);
  }

  boxScoreAdvancedV3(params: BoxScoreAdvancedV3Params): Promise<BoxScoreAdvancedV3Response> {
    return boxScoreAdvancedV3(this.client, params);
  }

  boxScoreDefensiveV2(params: BoxScoreDefensiveV2Params): Promise<BoxScoreDefensiveV2Response> {
    return boxScoreDefensiveV2(this.client, params);
  }

  boxScoreFourFactorsV2(params: BoxScoreFourFactorsV2Params): Promise<BoxScoreFourFactorsV2Response> {
    return boxScoreFourFactorsV2(this.client, params);
  }

  boxScoreFourFactorsV3(params: BoxScoreFourFactorsV3Params): Promise<BoxScoreFourFactorsV3Response> {
    return boxScoreFourFactorsV3(this.client, params);
  }

  boxScoreHustleV2(params: BoxScoreHustleV2Params): Promise<BoxScoreHustleV2Response> {
    return boxScoreHustleV2(this.client, params);
  }

  boxScoreMatchupsV3(params: BoxScoreMatchupsV3Params): Promise<BoxScoreMatchupsV3Response> {
    return boxScoreMatchupsV3(this.client, params);
  }

  boxScoreMiscV2(params: BoxScoreMiscV2Params): Promise<BoxScoreMiscV2Response> {
    return boxScoreMiscV2(this.client, params);
  }

  boxScoreMiscV3(params: BoxScoreMiscV3Params): Promise<BoxScoreMiscV3Response> {
    return boxScoreMiscV3(this.client, params);
  }

  boxScorePlayerTrackV3(params: BoxScorePlayerTrackV3Params): Promise<BoxScorePlayerTrackV3Response> {
    return boxScorePlayerTrackV3(this.client, params);
  }

  boxScoreScoringV2(params: BoxScoreScoringV2Params): Promise<BoxScoreScoringV2Response> {
    return boxScoreScoringV2(this.client, params);
  }

  boxScoreScoringV3(params: BoxScoreScoringV3Params): Promise<BoxScoreScoringV3Response> {
    return boxScoreScoringV3(this.client, params);
  }

  boxScoreSummaryV2(params: BoxScoreSummaryV2Params): Promise<BoxScoreSummaryV2Response> {
    return boxScoreSummaryV2(this.client, params);
  }

  boxScoreSummaryV3(params: BoxScoreSummaryV3Params): Promise<BoxScoreSummaryV3Response> {
    return boxScoreSummaryV3(this.client, params);
  }

  boxScoreTraditionalV2(params: BoxScoreTraditionalV2Params): Promise<BoxScoreTraditionalV2Response> {
    return boxScoreTraditionalV2(this.client, params);
  }

  boxScoreTraditionalV3(params: BoxScoreTraditionalV3Params): Promise<BoxScoreTraditionalV3Response> {
    return boxScoreTraditionalV3(this.client, params);
  }

  boxScoreUsageV2(params: BoxScoreUsageV2Params): Promise<BoxScoreUsageV2Response> {
    return boxScoreUsageV2(this.client, params);
  }

  boxScoreUsageV3(params: BoxScoreUsageV3Params): Promise<BoxScoreUsageV3Response> {
    return boxScoreUsageV3(this.client, params);
  }

  commonAllPlayers(params: CommonAllPlayersParams): Promise<CommonAllPlayersResponse> {
    return commonAllPlayers(this.client, params);
  }

  commonPlayerInfo(params: CommonPlayerInfoParams): Promise<CommonPlayerInfoResponse> {
    return commonPlayerInfo(this.client, params);
  }

  commonPlayoffSeries(params: CommonPlayoffSeriesParams): Promise<CommonPlayoffSeriesResponse> {
    return commonPlayoffSeries(this.client, params);
  }

  commonTeamRoster(params: CommonTeamRosterParams): Promise<CommonTeamRosterResponse> {
    return commonTeamRoster(this.client, params);
  }

  commonTeamYears(params: CommonTeamYearsParams): Promise<CommonTeamYearsResponse> {
    return commonTeamYears(this.client, params);
  }

  cumeStatsPlayer(params: CumeStatsPlayerParams): Promise<CumeStatsPlayerResponse> {
    return cumeStatsPlayer(this.client, params);
  }

  cumeStatsPlayerGames(params: CumeStatsPlayerGamesParams): Promise<CumeStatsPlayerGamesResponse> {
  ...
  cumeStatsTeamGames(params: CumeStatsTeamGamesParams): Promise<CumeStatsTeamGamesResponse> {
  ...
  draftCombineDrillResults(params: DraftCombineDrillResultsParams): Promise<DraftCombineDrillResultsResponse> {
    return draftCombineDrillResults(this.client, params);
  }

  draftCombineNonStationaryShooting(params: DraftCombineNonStationaryShootingParams): Promise<DraftCombineNonStationaryShootingResponse> {
    return draftCombineNonStationaryShooting(this.client, params);
  }

  draftCombinePlayerAnthro(params: DraftCombinePlayerAnthroParams): Promise<DraftCombinePlayerAnthroResponse> {
    return draftCombinePlayerAnthro(this.client, params);
  }

  draftCombineSpotShooting(params: DraftCombineSpotShootingParams): Promise<DraftCombineSpotShootingResponse> {
    return draftCombineSpotShooting(this.client, params);
  }

  draftCombineStats(params: DraftCombineStatsParams): Promise<DraftCombineStatsResponse> {
  ...
  dunkScoreLeaders(params: DunkScoreLeadersParams): Promise<DunkScoreLeadersResponse> {
  ...
  franchiseHistory(params: FranchiseHistoryParams): Promise<FranchiseHistoryResponse> {
    return franchiseHistory(this.client, params);
  }

  franchiseLeaders(params: FranchiseLeadersParams): Promise<FranchiseLeadersResponse> {
    return franchiseLeaders(this.client, params);
  }

  franchisePlayers(params: FranchisePlayersParams): Promise<FranchisePlayersResponse> {
  ...
  gLAlumBoxScoreSimilarityScore(params: GLAlumBoxScoreSimilarityScoreParams): Promise<GLAlumBoxScoreSimilarityScoreResponse> {
    return gLAlumBoxScoreSimilarityScore(this.client, params);
  }

  homePageLeaders(params: HomePageLeadersParams): Promise<HomePageLeadersResponse> {
  ...
  hustleStatsBoxScore(params: HustleStatsBoxScoreParams): Promise<HustleStatsBoxScoreResponse> {
    return hustleStatsBoxScore(this.client, params);
  }

  infographicFanDuelPlayer(params: InfographicFanDuelPlayerParams): Promise<InfographicFanDuelPlayerResponse> {
  ...
  leagueDashLineups(params: LeagueDashLineupsParams): Promise<LeagueDashLineupsResponse> {
    return leagueDashLineups(this.client, params);
  }

  leagueDashOppPtShot(params: LeagueDashOppPtShotParams): Promise<LeagueDashOppPtShotResponse> {
    return leagueDashOppPtShot(this.client, params);
  }

  leagueDashPlayerBioStats(params: LeagueDashPlayerBioStatsParams): Promise<LeagueDashPlayerBioStatsResponse> {
    return leagueDashPlayerBioStats(this.client, params);
  }

  leagueDashPlayerClutch(params: LeagueDashPlayerClutchParams): Promise<LeagueDashPlayerClutchResponse> {
    return leagueDashPlayerClutch(this.client, params);
  }

  leagueDashPlayerPtShot(params: LeagueDashPlayerPtShotParams): Promise<LeagueDashPlayerPtShotResponse> {
    return leagueDashPlayerPtShot(this.client, params);
  }

  leagueDashPlayerShotLocations(params: LeagueDashPlayerShotLocationsParams): Promise<LeagueDashPlayerShotLocationsResponse> {
    return leagueDashPlayerShotLocations(this.client, params);
  }

  leagueDashPlayerStats(params: LeagueDashPlayerStatsParams): Promise<LeagueDashPlayerStatsResponse> {
    return leagueDashPlayerStats(this.client, params);
  }

  leagueDashPtDefend(params: LeagueDashPtDefendParams): Promise<LeagueDashPtDefendResponse> {
    return leagueDashPtDefend(this.client, params);
  }

  leagueDashPtStats(params: LeagueDashPtStatsParams): Promise<LeagueDashPtStatsResponse> {
    return leagueDashPtStats(this.client, params);
  }

  leagueDashPtTeamDefend(params: LeagueDashPtTeamDefendParams): Promise<LeagueDashPtTeamDefendResponse> {
    return leagueDashPtTeamDefend(this.client, params);
  }

  leagueDashTeamClutch(params: LeagueDashTeamClutchParams): Promise<LeagueDashTeamClutchResponse> {
    return leagueDashTeamClutch(this.client, params);
  }

  leagueDashTeamPtShot(params: LeagueDashTeamPtShotParams): Promise<LeagueDashTeamPtShotResponse> {
    return leagueDashTeamPtShot(this.client, params);
  }

  leagueDashTeamShotLocations(params: LeagueDashTeamShotLocationsParams): Promise<LeagueDashTeamShotLocationsResponse> {
    return leagueDashTeamShotLocations(this.client, params);
  }

  leagueDashTeamStats(params: LeagueDashTeamStatsParams): Promise<LeagueDashTeamStatsResponse> {
    return leagueDashTeamStats(this.client, params);
  }

  leagueGameFinder(params: LeagueGameFinderParams): Promise<LeagueGameFinderResponse> {
  ...
  leagueHustleStatsPlayer(params: LeagueHustleStatsPlayerParams): Promise<LeagueHustleStatsPlayerResponse> {
    return leagueHustleStatsPlayer(this.client, params);
  }

  leagueHustleStatsTeam(params: LeagueHustleStatsTeamParams): Promise<LeagueHustleStatsTeamResponse> {
  ...
  leagueLineupViz(params: LeagueLineupVizParams): Promise<LeagueLineupVizResponse> {
    return leagueLineupViz(this.client, params);
  }

  leaguePlayerOnDetails(params: LeaguePlayerOnDetailsParams): Promise<LeaguePlayerOnDetailsResponse> {
    return leaguePlayerOnDetails(this.client, params);
  }

  leagueSeasonMatchups(params: LeagueSeasonMatchupsParams): Promise<LeagueSeasonMatchupsResponse> {
    return leagueSeasonMatchups(this.client, params);
  }

  leagueStandings(params: LeagueStandingsParams): Promise<LeagueStandingsResponse> {
    return leagueStandings(this.client, params);
  }

  leagueStandingsV3(params: LeagueStandingsV3Params): Promise<LeagueStandingsV3Response> {
    return leagueStandingsV3(this.client, params);
  }

  matchupsRollup(params: MatchupsRollupParams): Promise<MatchupsRollupResponse> {
  ...
  playerCareerByCollege(params: PlayerCareerByCollegeParams): Promise<PlayerCareerByCollegeResponse> {
    return playerCareerByCollege(this.client, params);
  }

  playerCareerByCollegeRollup(params: PlayerCareerByCollegeRollupParams): Promise<PlayerCareerByCollegeRollupResponse> {
    return playerCareerByCollegeRollup(this.client, params);
  }

  playerCareerStats(params: PlayerCareerStatsParams): Promise<PlayerCareerStatsResponse> {
  ...
  playerDashPtPass(params: PlayerDashPtPassParams): Promise<PlayerDashPtPassResponse> {
    return playerDashPtPass(this.client, params);
  }

  playerDashPtReb(params: PlayerDashPtRebParams): Promise<PlayerDashPtRebResponse> {
    return playerDashPtReb(this.client, params);
  }

  playerDashPtShotDefend(params: PlayerDashPtShotDefendParams): Promise<PlayerDashPtShotDefendResponse> {
    return playerDashPtShotDefend(this.client, params);
  }

  playerDashPtShots(params: PlayerDashPtShotsParams): Promise<PlayerDashPtShotsResponse> {
    return playerDashPtShots(this.client, params);
  }

  playerDashboardByClutch(params: PlayerDashboardByClutchParams): Promise<PlayerDashboardByClutchResponse> {
    return playerDashboardByClutch(this.client, params);
  }

  playerDashboardByGameSplits(params: PlayerDashboardByGameSplitsParams): Promise<PlayerDashboardByGameSplitsResponse> {
    return playerDashboardByGameSplits(this.client, params);
  }

  playerDashboardByGeneralSplits(params: PlayerDashboardByGeneralSplitsParams): Promise<PlayerDashboardByGeneralSplitsResponse> {
    return playerDashboardByGeneralSplits(this.client, params);
  }

  playerDashboardByLastNGames(params: PlayerDashboardByLastNGamesParams): Promise<PlayerDashboardByLastNGamesResponse> {
    return playerDashboardByLastNGames(this.client, params);
  }

  playerDashboardByShootingSplits(params: PlayerDashboardByShootingSplitsParams): Promise<PlayerDashboardByShootingSplitsResponse> {
    return playerDashboardByShootingSplits(this.client, params);
  }

  playerDashboardByTeamPerformance(params: PlayerDashboardByTeamPerformanceParams): Promise<PlayerDashboardByTeamPerformanceResponse> {
    return playerDashboardByTeamPerformance(this.client, params);
  }

  playerDashboardByYearOverYear(params: PlayerDashboardByYearOverYearParams): Promise<PlayerDashboardByYearOverYearResponse> {
    return playerDashboardByYearOverYear(this.client, params);
  }

  playerEstimatedMetrics(params: PlayerEstimatedMetricsParams): Promise<PlayerEstimatedMetricsResponse> {
    return playerEstimatedMetrics(this.client, params);
  }

  playerFantasyProfileBarGraph(params: PlayerFantasyProfileBarGraphParams): Promise<PlayerFantasyProfileBarGraphResponse> {
  ...
  playerGameLogs(params: PlayerGameLogsParams): Promise<PlayerGameLogsResponse> {
    return playerGameLogs(this.client, params);
  }

  playerGameStreakFinder(params: PlayerGameStreakFinderParams): Promise<PlayerGameStreakFinderResponse> {
  ...
  playerNextNGames(params: PlayerNextNGamesParams): Promise<PlayerNextNGamesResponse> {
    return playerNextNGames(this.client, params);
  }

  playerProfileV2(params: PlayerProfileV2Params): Promise<PlayerProfileV2Response> {
    return playerProfileV2(this.client, params);
  }

  playerVsPlayer(params: PlayerVsPlayerParams): Promise<PlayerVsPlayerResponse> {
    return playerVsPlayer(this.client, params);
  }

  playoffPicture(params: PlayoffPictureParams): Promise<PlayoffPictureResponse> {
    return playoffPicture(this.client, params);
  }

  scheduleLeagueV2(params: ScheduleLeagueV2Params): Promise<ScheduleLeagueV2Response> {
    return scheduleLeagueV2(this.client, params);
  }

  scheduleLeagueV2Int(params: ScheduleLeagueV2IntParams): Promise<ScheduleLeagueV2IntResponse> {
  ...
  shotChartDetail(params: ShotChartDetailParams): Promise<ShotChartDetailResponse> {
    return shotChartDetail(this.client, params);
  }

  shotChartLeagueWide(params: ShotChartLeagueWideParams): Promise<ShotChartLeagueWideResponse> {
    return shotChartLeagueWide(this.client, params);
  }

  shotChartLineupDetail(params: ShotChartLineupDetailParams): Promise<ShotChartLineupDetailResponse> {
    return shotChartLineupDetail(this.client, params);
  }

  synergyPlayTypes(params: SynergyPlayTypesParams): Promise<SynergyPlayTypesResponse> {
    return synergyPlayTypes(this.client, params);
  }

  teamAndPlayersVsPlayers(params: TeamAndPlayersVsPlayersParams): Promise<TeamAndPlayersVsPlayersResponse> {
    return teamAndPlayersVsPlayers(this.client, params);
  }

  teamDashLineups(params: TeamDashLineupsParams): Promise<TeamDashLineupsResponse> {
    return teamDashLineups(this.client, params);
  }

  teamDashPtPass(params: TeamDashPtPassParams): Promise<TeamDashPtPassResponse> {
  ...
  teamDashPtShots(params: TeamDashPtShotsParams): Promise<TeamDashPtShotsResponse> {
    return teamDashPtShots(this.client, params);
  }

  teamDashboardByGeneralSplits(params: TeamDashboardByGeneralSplitsParams): Promise<TeamDashboardByGeneralSplitsResponse> {
    return teamDashboardByGeneralSplits(this.client, params);
  }

  teamDashboardByShootingSplits(params: TeamDashboardByShootingSplitsParams): Promise<TeamDashboardByShootingSplitsResponse> {
  ...
  teamEstimatedMetrics(params: TeamEstimatedMetricsParams): Promise<TeamEstimatedMetricsResponse> {
  ...
  teamGameStreakFinder(params: TeamGameStreakFinderParams): Promise<TeamGameStreakFinderResponse> {
    return teamGameStreakFinder(this.client, params);
  }

  teamHistoricalLeaders(params: TeamHistoricalLeadersParams): Promise<TeamHistoricalLeadersResponse> {
    return teamHistoricalLeaders(this.client, params);
  }

  teamInfoCommon(params: TeamInfoCommonParams): Promise<TeamInfoCommonResponse> {
    return teamInfoCommon(this.client, params);
  }

  teamPlayerDashboard(params: TeamPlayerDashboardParams): Promise<TeamPlayerDashboardResponse> {
    return teamPlayerDashboard(this.client, params);
  }

  teamPlayerOnOffDetails(params: TeamPlayerOnOffDetailsParams): Promise<TeamPlayerOnOffDetailsResponse> {
    return teamPlayerOnOffDetails(this.client, params);
  }

  teamPlayerOnOffSummary(params: TeamPlayerOnOffSummaryParams): Promise<TeamPlayerOnOffSummaryResponse> {
  ...
  teamYearByYearStats(params: TeamYearByYearStatsParams): Promise<TeamYearByYearStatsResponse> {
  ...
  videoDetailsAsset(params: VideoDetailsAssetParams): Promise<VideoDetailsAssetResponse> {
  ...
  videoEventsAsset(params: VideoEventsAssetParams): Promise<VideoEventsAssetResponse> {
  ...
  winProbabilityPBP(params: WinProbabilityPBPParams): Promise<WinProbabilityPBPResponse> {
