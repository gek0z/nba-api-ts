...
import type { PlayerDashboardByGeneralSplitsParams, PlayerDashboardByGeneralSplitsResponse } from '../types/player-dashboard-by-general-splits.js';
...
export async function playerDashboardByGeneralSplits(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/playerdashboardbygeneralsplits', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as PlayerDashboardByGeneralSplitsResponse;
}
