...
import type { FantasyWidgetParams, FantasyWidgetResponse } from '../types/fantasy-widget.js';
...
export async function fantasyWidget(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/fantasywidget', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as FantasyWidgetResponse;
}
