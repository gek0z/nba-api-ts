...
import type { GLAlumBoxScoreSimilarityScoreParams, GLAlumBoxScoreSimilarityScoreResponse } from '../types/gl-alum-box-score-similarity-score.js';
...
export async function gLAlumBoxScoreSimilarityScore(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/glalumboxscoresimilarityscore', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as GLAlumBoxScoreSimilarityScoreResponse;
}
