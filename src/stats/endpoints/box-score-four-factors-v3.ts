...
import type { BoxScoreFourFactorsV3Params, BoxScoreFourFactorsV3Response } from '../types/box-score-four-factors-v3.js';
...
export async function boxScoreFourFactorsV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/boxscorefourfactorsv3', apiParams);
