...
import type { LeagueHustleStatsTeamParams, LeagueHustleStatsTeamResponse } from '../types/league-hustle-stats-team.js';
...
export async function leagueHustleStatsTeam(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguehustlestatsteam', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueHustleStatsTeamResponse;
}
