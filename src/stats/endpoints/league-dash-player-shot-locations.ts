...
import type { LeagueDashPlayerShotLocationsParams, LeagueDashPlayerShotLocationsResponse } from '../types/league-dash-player-shot-locations.js';
...
export async function leagueDashPlayerShotLocations(
  client: FetchClient,
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguedashplayershotlocations', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueDashPlayerShotLocationsResponse;
}
