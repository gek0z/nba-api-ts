...
import type { BoxScoreTraditionalV3Params, BoxScoreTraditionalV3Response } from '../types/box-score-traditional-v3.js';
...
export async function boxScoreTraditionalV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/boxscoretraditionalv3', apiParams);
