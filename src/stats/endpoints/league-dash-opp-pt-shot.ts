...
import type { LeagueDashOppPtShotParams, LeagueDashOppPtShotResponse } from '../types/league-dash-opp-pt-shot.js';
...
export async function leagueDashOppPtShot(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguedashoppptshot', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueDashOppPtShotResponse;
}
