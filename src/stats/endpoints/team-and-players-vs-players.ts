...
import type { TeamAndPlayersVsPlayersParams, TeamAndPlayersVsPlayersResponse } from '../types/team-and-players-vs-players.js';
...
export async function teamAndPlayersVsPlayers(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/teamandplayersvsplayers', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as TeamAndPlayersVsPlayersResponse;
}
