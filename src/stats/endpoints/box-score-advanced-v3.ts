...
import type { BoxScoreAdvancedV3Params, BoxScoreAdvancedV3Response } from '../types/box-score-advanced-v3.js';
...
export async function boxScoreAdvancedV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/boxscoreadvancedv3', apiParams);
