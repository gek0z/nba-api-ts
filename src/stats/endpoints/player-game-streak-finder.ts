...
import type { PlayerGameStreakFinderParams, PlayerGameStreakFinderResponse } from '../types/player-game-streak-finder.js';

const RESULT_SET_MAP: Record<string, string> = {
  'PlayerGameStreakFinderResults': 'playerGameStreakFinderResults',
};

export async function playerGameStreakFinder(
  client: FetchClient,
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/playergamestreakfinder', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as PlayerGameStreakFinderResponse;
}
