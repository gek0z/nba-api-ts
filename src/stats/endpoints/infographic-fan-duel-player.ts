...
} from "../types/infographic-fan-duel-player.js";
...
export async function infographicFanDuelPlayer(
	client: FetchClient,
	_params: InfographicFanDuelPlayerParams,
): Promise<InfographicFanDuelPlayerResponse> {
	const apiParams: Record<string, string | number | undefined> = {};

	const raw = await client.get<RawNBAStatsResponse>(
		"/stats/infographicfanduelplayer",
		apiParams,
	);
	return parseStatsResponse(
		raw,
		RESULT_SET_MAP,
	) as unknown as InfographicFanDuelPlayerResponse;
}
