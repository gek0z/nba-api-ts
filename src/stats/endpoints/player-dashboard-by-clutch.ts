...
import type { PlayerDashboardByClutchParams, PlayerDashboardByClutchResponse } from '../types/player-dashboard-by-clutch.js';
...
const RESULT_SET_MAP: Record<string, string> = {
  ...
  'Last1MinPlusMinus5PointPlayerDashboard': 'last1MinPlusMinus5PointPlayerDashboard',
  ...
  'Last3MinPlusMinus5PointPlayerDashboard': 'last3MinPlusMinus5PointPlayerDashboard',
  'Last5Min5PointPlayerDashboard': 'last5Min5PointPlayerDashboard',
  'Last5MinPlusMinus5PointPlayerDashboard': 'last5MinPlusMinus5PointPlayerDashboard',
...
export async function playerDashboardByClutch(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/playerdashboardbyclutch', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as PlayerDashboardByClutchResponse;
}
