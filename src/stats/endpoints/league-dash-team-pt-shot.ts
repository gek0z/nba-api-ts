...
import type { LeagueDashTeamPtShotParams, LeagueDashTeamPtShotResponse } from '../types/league-dash-team-pt-shot.js';

const RESULT_SET_MAP: Record<string, string> = {
  'LeagueDashPTShots': 'leagueDashPTShots',
};

export async function leagueDashTeamPtShot(
  client: FetchClient,
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguedashteamptshot', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueDashTeamPtShotResponse;
}
