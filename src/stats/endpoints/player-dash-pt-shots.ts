...
import type { PlayerDashPtShotsParams, PlayerDashPtShotsResponse } from '../types/player-dash-pt-shots.js';
...
export async function playerDashPtShots(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/playerdashptshots', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as PlayerDashPtShotsResponse;
}
