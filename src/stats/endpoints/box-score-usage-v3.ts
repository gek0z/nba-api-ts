...
import type { BoxScoreUsageV3Params, BoxScoreUsageV3Response } from '../types/box-score-usage-v3.js';
...
export async function boxScoreUsageV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/boxscoreusagev3', apiParams);
