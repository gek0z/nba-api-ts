...
import type { ScoreboardV3Params, ScoreboardV3Response } from '../types/scoreboard-v3.js';
...
export async function scoreboardV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/scoreboardv3', apiParams);
