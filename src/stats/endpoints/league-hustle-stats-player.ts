...
import type { LeagueHustleStatsPlayerParams, LeagueHustleStatsPlayerResponse } from '../types/league-hustle-stats-player.js';
...
export async function leagueHustleStatsPlayer(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguehustlestatsplayer', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueHustleStatsPlayerResponse;
}
