...
import type { LeadersTilesParams, LeadersTilesResponse } from '../types/leaders-tiles.js';
...
export async function leadersTiles(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaderstiles', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeadersTilesResponse;
}
