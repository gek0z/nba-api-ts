...
import type { PlayerDashPtRebParams, PlayerDashPtRebResponse } from '../types/player-dash-pt-reb.js';
...
export async function playerDashPtReb(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/playerdashptreb', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as PlayerDashPtRebResponse;
}
