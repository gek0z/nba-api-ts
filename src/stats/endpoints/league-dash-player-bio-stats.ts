...
import type { LeagueDashPlayerBioStatsParams, LeagueDashPlayerBioStatsResponse } from '../types/league-dash-player-bio-stats.js';
...
export async function leagueDashPlayerBioStats(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguedashplayerbiostats', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueDashPlayerBioStatsResponse;
}
