...
import type { BoxScoreMiscV3Params, BoxScoreMiscV3Response } from '../types/box-score-misc-v3.js';
...
export async function boxScoreMiscV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/boxscoremiscv3', apiParams);
