...
import type { PlayByPlayV3Params, PlayByPlayV3Response } from '../types/play-by-play-v3.js';
...
export async function playByPlayV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/playbyplayv3', apiParams);
