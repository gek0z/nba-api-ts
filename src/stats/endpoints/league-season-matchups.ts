...
import type { LeagueSeasonMatchupsParams, LeagueSeasonMatchupsResponse } from '../types/league-season-matchups.js';
...
export async function leagueSeasonMatchups(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leagueseasonmatchups', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueSeasonMatchupsResponse;
}
