...
import type { LeagueDashPlayerClutchParams, LeagueDashPlayerClutchResponse } from '../types/league-dash-player-clutch.js';
...
export async function leagueDashPlayerClutch(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguedashplayerclutch', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueDashPlayerClutchResponse;
}
