...
import type { LeagueDashTeamClutchParams, LeagueDashTeamClutchResponse } from '../types/league-dash-team-clutch.js';
...
export async function leagueDashTeamClutch(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguedashteamclutch', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueDashTeamClutchResponse;
}
