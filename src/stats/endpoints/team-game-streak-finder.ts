...
import type { TeamGameStreakFinderParams, TeamGameStreakFinderResponse } from '../types/team-game-streak-finder.js';

const RESULT_SET_MAP: Record<string, string> = {
  'TeamGameStreakFinderParametersResults': 'teamGameStreakFinderParametersResults',
};
...
export async function teamGameStreakFinder(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/teamgamestreakfinder', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as TeamGameStreakFinderResponse;
}
