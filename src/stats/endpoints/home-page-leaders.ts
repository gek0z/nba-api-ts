...
import type { HomePageLeadersParams, HomePageLeadersResponse } from '../types/home-page-leaders.js';
...
export async function homePageLeaders(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/homepageleaders', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as HomePageLeadersResponse;
}
