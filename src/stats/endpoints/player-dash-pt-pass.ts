...
import type { PlayerDashPtPassParams, PlayerDashPtPassResponse } from '../types/player-dash-pt-pass.js';
...
export async function playerDashPtPass(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/playerdashptpass', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as PlayerDashPtPassResponse;
}
