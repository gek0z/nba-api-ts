...
import type { ShotChartDetailParams, ShotChartDetailResponse } from '../types/shot-chart-detail.js';
...
export async function shotChartDetail(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/shotchartdetail', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as ShotChartDetailResponse;
}
