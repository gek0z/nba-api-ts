...
import type { LeagueDashLineupsParams, LeagueDashLineupsResponse } from '../types/league-dash-lineups.js';
...
export async function leagueDashLineups(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/leaguedashlineups', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as LeagueDashLineupsResponse;
}
