...
import type { BoxScorePlayerTrackV3Params, BoxScorePlayerTrackV3Response } from '../types/box-score-player-track-v3.js';
...
export async function boxScorePlayerTrackV3(
  ...
  const raw = await client.get<Record<string, unknown>>('/stats/boxscoreplayertrackv3', apiParams);
