...
import type { VideoDetailsAssetParams, VideoDetailsAssetResponse } from '../types/video-details-asset.js';
...
export async function videoDetailsAsset(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/videodetailsasset', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as VideoDetailsAssetResponse;
}
