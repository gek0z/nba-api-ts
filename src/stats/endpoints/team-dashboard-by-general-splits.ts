...
import type { TeamDashboardByGeneralSplitsParams, TeamDashboardByGeneralSplitsResponse } from '../types/team-dashboard-by-general-splits.js';
...
export async function teamDashboardByGeneralSplits(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/teamdashboardbygeneralsplits', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as TeamDashboardByGeneralSplitsResponse;
}
