...
import type { TeamDashPtPassParams, TeamDashPtPassResponse } from '../types/team-dash-pt-pass.js';
...
export async function teamDashPtPass(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/teamdashptpass', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as TeamDashPtPassResponse;
}
