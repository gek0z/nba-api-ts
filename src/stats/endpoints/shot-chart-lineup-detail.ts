...
import type { ShotChartLineupDetailParams, ShotChartLineupDetailResponse } from '../types/shot-chart-lineup-detail.js';
...
export async function shotChartLineupDetail(
  ...
  const raw = await client.get<RawNBAStatsResponse>('/stats/shotchartlineupdetail', apiParams);
  return parseStatsResponse(raw, RESULT_SET_MAP) as unknown as ShotChartLineupDetailResponse;
}
